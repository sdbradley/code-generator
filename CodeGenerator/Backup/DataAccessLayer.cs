    ...
    public class DataAccessLayer {
        ...
        private bool CreateDataAccessLayer(string nameSpace, string Schema, string tableName) {
            ...
            try {
                ...
                sb.Append(" = new ");
                sb.Append(nameSpace);
                sb.Append(".Common.Collections.");
                sb.Append(tableName.Replace(" ", string.Empty));
                sb.AppendLine("EntityCollection();");
                ...
                sb.AppendLine("cmd.Parameters.Add(new SqlParameter(\"@pageIndex\", pageIndex));");
                sb.AppendLine("cmd.Parameters.Add(new SqlParameter(\"@pageSize\", pageSize));");
